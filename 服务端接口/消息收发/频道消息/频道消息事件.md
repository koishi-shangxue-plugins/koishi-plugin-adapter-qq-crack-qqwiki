...
## AT\_MESSAGE\_CREATE（intents PUBLIC\_GUILD\_MESSAGES）
...
## MESSAGE\_CREATE（intents PUBLIC\_GUILD\_MESSAGES，私域）
...
## DIRECT\_MESSAGE\_CREATE（intents DIRECT\_MESSAGE）
...
### MESSAGE\_AUDIT\_PASS（intents MESSAGE\_AUDIT）
...
### MESSAGE\_AUDIT\_REJECT（intents MESSAGE\_AUDIT）

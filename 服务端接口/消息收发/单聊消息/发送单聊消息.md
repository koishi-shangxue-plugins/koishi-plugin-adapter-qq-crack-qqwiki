...
| content | string | 否 | Markdown 内容。支持的格式参考文档：[Markdown](https://bot.q.qq.com/wiki/develop/api-v2/server-inter/message/type/markdown.html) |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| message\_id | string | 否 | 被引用消息 ID，例如REFIDX\_xxxxxx 

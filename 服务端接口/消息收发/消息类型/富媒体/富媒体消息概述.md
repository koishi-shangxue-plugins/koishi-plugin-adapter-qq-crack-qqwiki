...
| 图片 | 语音 | 视频 | 文件 |
| --- | --- | --- | --- |
| ![图片消息](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.33.0/assets/img/image-send.35813305.jpg) | ![语音消息](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.33.0/assets/img/voice-send.21dce8bf.jpg) | ![视频消息](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.33.0/assets/img/video-send.9416079c.jpg) | ![文件消息](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.33.0/assets/img/large-file-transfer.f49ff1e2.jpg) |
...
整文件上传使用 [单聊上传](%E5%8D%95%E8%81%8A%E5%AF%8C%E5%AA%92%E4%BD%93%E4%B8%8A%E4%BC%A0.md) / [群聊上传](%E7%BE%A4%E8%81%8A%E5%AF%8C%E5%AA%92%E4%BD%93%E4%B8%8A%E4%BC%A0.md) 接口，直接传入文件 URL；文件较大时使用分片上传，参考 [单聊预上传](%E5%8D%95%E8%81%8A%E5%AF%8C%E5%AA%92%E4%BD%93%E9%A2%84%E4%B8%8A%E4%BC%A0.md) 开始分片流程。
...
- file\_info 有有效期（ ttl ），过期后需重新上传。
- md5\_10m （文件前 10002432 字节，约 9.54 MB 的 MD5）可用于秒传判断，避免重复上传。
- 分片大小默认 5MB，并发数、重试策略由服务端在 upload\_config 中下发。
- 上传接口超时建议设为 ≥ 5 秒。

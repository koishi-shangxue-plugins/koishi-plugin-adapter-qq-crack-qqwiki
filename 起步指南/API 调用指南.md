...
> **举例**
> - 不同 bot 在单聊场景，获取到的用户唯一识别 openid 不一样，称为 user\_openid
> - 不同 bot 在群聊场景，获取到的群唯一识别号 openid 不一样，称为 group\_openid
> - bot 在群聊场景，获取到用户在群内的唯一识别号，称为 member\_openid
